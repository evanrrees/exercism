...
def categorize_dish(dish_name, dish_ingredients):
    ...
    for category_name, category_ingredients in DISH_CATEGORIES.items():
        if cleaned_ingredients <= category_ingredients:
...
def compile_ingredients(dishes):
    ...
    """
    return functools.reduce(set.__or__, dishes)
...
def singleton_ingredients(dishes, intersection):
    ...
    """
    return functools.reduce(set.__or__, dishes) - intersection
